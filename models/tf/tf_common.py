...
class TFBaseConv2d(keras.layers.Layer):
    ...
    def __init__(self, w=None):
        super().__init__()
        assert w.groups in [1,
                            w.in_channels], "Argument(g) only be 1 for conv2d, or be in_channels for depthwise conv2d"
